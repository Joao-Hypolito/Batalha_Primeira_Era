...
namespace Batalha_Primeira_Era.Items.Weapons
{
    ...
    public float KnowScaling { get; private set; }
        ...
        public Sword(string name, float baseDamage, int reStrength, int reDexterity, int reKnowledge, float dexScaling, float strScaling, float knowScaling) :
        ...
        public override float CalculateDamage(Batalha_Primeira_Era.Core.Character wielder)
        {
            ...
            // Agora a fórmula usa os atributos do personagem MULTIPLICADOS pelo escalonamento único DESSA espada
